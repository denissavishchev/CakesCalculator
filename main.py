...
class Muffin(FloatLayout):
    ...
    def result(self):
        try:
            if self.circleButtonTop.state == 'down' and self.circleButtonDown.state == 'down':
                self.text_label.text = str(round(
                    int(self.text_circle_bottom.text) * (int(self.text_circle_bottom.text)) / (
                                int(self.text_circle_top.text) * (int(self.text_circle_top.text))), 4))
            elif self.circleButtonTop.state == 'down' and self.squareButtonDown.state == 'down':
                self.text_label.text = str(round((((int(self.text_circle_bottom.text)) * (
                    int(self.text_circle_bottom.text))) / ((((int(self.text_circle_top.text)) / 2) * (
                            (int(self.text_circle_top.text)) / 2)) * 3.1415)), 4))
            elif self.circleButtonTop.state == 'down' and self.rectButtonDown.state == 'down':
                self.text_label.text = str(round((((int(self.text_circle_bottom.text)) * (
                    int(self.text_rect_bottom.text))) / ((((int(self.text_circle_top.text)) / 2) * (
                            (int(self.text_circle_top.text)) / 2)) * 3.1415)), 4))

            elif self.squareButtonTop.state == 'down' and self.circleButtonDown.state == 'down':
                self.text_label.text = str(round((((((int(self.text_circle_bottom.text)) / 2) * (
                            (int(self.text_circle_bottom.text)) / 2)) * 3.1415)) / ((int(self.text_circle_top.text)) * (
                    int(self.text_circle_top.text))), 4))
            elif self.squareButtonTop.state == 'down' and self.squareButtonDown.state == 'down':
                self.text_label.text = str(round((((int(self.text_circle_bottom.text)) * (
                    int(self.text_circle_bottom.text))) / ((int(self.text_circle_top.text)) * (
                    int(self.text_circle_top.text)))), 4))
            elif self.squareButtonTop.state == 'down' and self.rectButtonDown.state == 'down':
                self.text_label.text = str(round((((int(self.text_circle_bottom.text)) * (
                    int(self.text_rect_bottom.text))) / ((int(self.text_circle_top.text)) * (
                    int(self.text_circle_top.text)))), 4))

            elif self.rectButtonTop.state == 'down' and self.circleButtonDown.state == 'down':
                self.text_label.text = str(round((((((int(self.text_circle_bottom.text)) / 2) * (
                            (int(self.text_circle_bottom.text)) / 2)) * 3.1415)) / ((int(self.text_circle_top.text)) * (
                    int(self.text_rect_top.text))), 4))
    ...
    def circle_textinput_top(self):
        ...
        self.text_circle_top.text = ''
        self.text_rect_top.text = ''
    ...
    def circle_textinput_bottom(self):
        ...
        self.text_circle_bottom.text = ''
        self.text_rect_bottom.text = ''
